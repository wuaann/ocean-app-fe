...
import {
    ...
    faBars, faClapperboard,
    faGear,
    faHouse,
    faMagnifyingGlass, faRepeat, faSquarePlus
...
function Sidebar() {
    ...
    const handleShowBtnCreate = () => {
        setShowButtonCreate(!showButtonCreate)
    }
        ...
        <>
            <div className={"flex "}>
                ...
                <div id="default-sidebar "
                       className=" fixed w-[20%] bg-black top-0 left-0 z-40  h-screen transition-transform -translate-x-full sm:translate-x-0"
                       aria-label="Sidebar">
                    <div
                        className="h-full px-3 py-4 overflow-y-auto dark:bg-black border-r-gray-700 border-r  flex flex-col justify-between">
                        <div>
                            <h1 className="font-lobster mt-3 mb-6 cursor-pointer text-transparent text-5xl bg-clip-text bg-gradient-to-r text-white ">
                                <NavLink to={"/"} className={"ml-3"}>Oceania</NavLink></h1>
                            ...
                            <ul className="space-y-2   text-white font-normal text-base">
                                ...
                                <li>
                                    <div onClick={() =>handleShowBtnCreate()}
                                             className="flex items-center p-3 m-1  cursor-pointer  text-white rounded-lg dark:text-white hover:bg-gray-100 hover:bg-opacity-10 dark:hover:bg-gray-700 group">
                ...
                <div className="p-0 absolute left-[20%]  w-[80%] bg-black  ">
                    {showButtonCreate && <CreatePost/>}
                    <Outlet/>
                </div>
            </div>
        </>
